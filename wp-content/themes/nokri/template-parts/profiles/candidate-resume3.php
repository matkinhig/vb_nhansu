...
if(isset($array_skills) && !empty($array_skills))
{
	foreach( $array_skills  as $r )
	{
		...
		$skills_bar .= '<div class="bar-wrapper">
								  ...
								  <div class="progress">
									<div class="progress-bar" role="progressbar" aria-valuenow="'.$r["value"].'" aria-valuemin="0" aria-valuemax="100" >  </div><span  class="popOver" data-toggle="tooltip" data-placement="top" title="'.$r["value"].'%"> </span>
								  </div>
								</div>'; 
	}
}
             ...
             <?php if($cand_introd != '') { ?>
                ...
                <div class="resume-3-box">
       			<div class="custom-field-box">
						  <h4><?php echo nokri_feilds_label('user_custom_feild_txt',esc_html__( 'Custom feilds', 'nokri' )); ?></h4>
